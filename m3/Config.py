...
#Signals
# signalsToTrain = 'GiveWay'
# signalsToTrain = 'Rectangles'
signalsToTrain = 'Circles'
# signalsToTrain = 'Squares'
# signalsToTrain = 'Triangles'
...
positive_folder = signalsToTrain
...
modelPath = 'Models/'+model+'_'+modelFeatures+'_'+signalsToTrain+'.model'
...
if model is 'SVM':
    if 'HOG' in featuresToExtract and 'LBP' in featuresToExtract:
        decision_threshold = -0.2  # for SVM-HOG-LBP
    elif 'HOG' in featuresToExtract:
        decision_threshold = 0.6  # for SVM-HOG
    ...
    if 'HOG' in featuresToExtract:
        ...
        decision_threshold = 2.0  # for LogisticRegression-LBP

# Vector to compensate the threshold values in different models
compensate = [0.1, 0, 0.1, 0, 0]
