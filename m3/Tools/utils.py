...
signalsToDetect = ['A13', 'A14', 'A15', 'A1A', 'A1B', 'A1C', 'A1D', 'A23', 'A23_geel', 'A25', 'A29', 'A30', 'A33', 'A39', 'A41', 'A51', 'A7A', 'A7B', 'A7C'
                   , 'B15A', 'B17', 'B1', 'B19', 'B5', 'B21', 'B11', 'B9'
                   , 'C1', 'C3', 'C11', 'C21', 'C23', 'C27', 'C29', 'C33', 'C31LEFT', 'C31RIGHT', 'C35', 'C43'
                   , 'D1a', 'D1b_rechts_onder', 'D1b_schuin_links', 'D1b_schuin_rechts', 'D10', 'D1b', 'D3b', 'D5', 'D7', 'D9'
                   , 'E1', 'E3', 'E5', 'E7', 'E9a', 'E9a_miva', 'E9b', 'E9c', 'E9d', 'E9e'
                   , 'F12a', 'F12b', 'F19', 'F45', 'F47', 'F49', 'F50', 'F59', 'F87'
                   , 'X4']
...
def readINRIAAnnotationsDetection(annotationsPath):
    ...
    with open(annotationsPath,'r') as fp:
        for line in fp:
            ...
            signalTypes.append(signalType[0])
